...
NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavbarComponent, selectors: [["navbar"]], decls: 10, vars: 0, consts: [[1, "nav", "justify-content-center"], [1, "nav-item"], ["routerLink", "", 1, "nav-link"], ["routerLink", "/blog", 1, "nav-link"], ["routerLink", "/contact", 1, "nav-link"]], template: function NavbarComponent_Template(rf, ctx) { if (rf & 1) {
